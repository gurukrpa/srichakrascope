...
export const REPORT_LAYOUT: ReportPage[] = [
  {
    ...
    density: "MEDIUM",
    sections: [
      { name: "Cover Header", purpose: "Student identification, assessment title, branding" },
      { name: "Student Details Card", purpose: "Name, date, completion stats" },
      { name: "Executive Summary", purpose: "High-level synthesis of assessment results" },
      { name: "How to Read This Report", purpose: "Explain Aptitude (16 objective) vs Preferences (60 self-report)" },
      { name: "Gentle Disclaimer", purpose: "Guidance tool, not final decisions" }
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { name: "Readiness Classification", purpose: "Categorize each aptitude: READY NOW / WITH DEVELOPMENT / EXPLORATORY" },
      { name: "Interpretation Text", purpose: "What these scores mean academically" }
    ],
  ...
  },
  {
    ...
    density: "MEDIUM",
    sections: [
      { name: "Interest Charts", purpose: "Visual representation of RIASEC/MI scores" },
      { name: "Preference Explanation", purpose: "What student enjoys and is motivated by" },
      { name: "Top Preference Domains", purpose: "List strongest interest areas" }
    ],
  ...
  },
  {
    ...
    density: "LIGHT",
    sections: [
      { name: "Brain Dominance Result", purpose: "Left/Right/Balanced classification" },
      { name: "Learning Style Profile", purpose: "How student processes information (visual/auditory/kinesthetic)" },
      { name: "Five Senses Learning Grid", purpose: "Multi-sensory learning preferences" },
      { name: "Study Strategy Implications", purpose: "How this affects learning approaches" }
    ],
  ...
  },
  {
    ...
    density: "HEAVY",
    sections: [
      { name: "Why This Recommendation Fits You", purpose: "Narrative explanation BEFORE table showing reasoning" },
      {
      ...
      { name: "Confidence Level Indicator", purpose: "Show certainty of recommendation" }
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { name: "Pathway Clarity Note", purpose: "Explain progression from Stream -> Course Family" }
    ],
  ...
  },
  {
    ...
    density: "MEDIUM",
    sections: [
      { name: "Strong Disclaimer", purpose: "This is EXPLORATION, not final career selection" },
      { name: "Career Cluster Cards", purpose: "Show 3-5 career families that align with profile" },
      { name: "Career Awareness Grid", purpose: "Broaden horizons, show possibilities" },
      { name: "No Rankings", purpose: "Explicitly avoid best career language" }
    ],
  ...
  },
  {
    ...
    density: "LIGHT",
    sections: [
      { name: "Next Steps for Student", purpose: "Immediate actionable items" },
      { name: "Next Steps for Parents", purpose: "How to support exploration" },
      { name: "Consultation Offer", purpose: "Srichakra Academy contact/consultation info" },
      { name: "Encouragement & Closing", purpose: "Positive, growth-oriented conclusion" }
    ],
...
$content | Out-File -FilePath "client\src\report\reportLayoutSpec.ts" -Encoding utf8 -NoNewline
Write-Host "Created reportLayoutSpec.ts"
