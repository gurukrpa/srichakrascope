# Direct file editing - Part 2: Replace Aptitude Ability Snapshot

$file = "client\src\pages\CareerAssessment.tsx"
$lines = Get-Content $file

# Replace lines 758-772 (the Aptitude Ability Snapshot section)
$newSection = @"
...
$newLines = @()
$newLines += $lines[0..757]  # Lines before the section
$newLines += $newSection.Split("`n")  # New section
$newLines += $lines[772..($lines.Length-1)]  # Lines after the section

# Write back to file
$newLines | Set-Content $file

Write-Host "✓ Updated Aptitude Ability Snapshot section (lines 758-772)" -ForegroundColor Green
